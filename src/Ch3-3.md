...
\[**72**\] IBM wanted to do a careful job on the software for Skylab. In
...
the control moment gyro \[**73**\] logic to reduce core usage and made
...
\[**74**\] Phase II represented another extensive revision of the
...
![\[**75**\] Figure 3-4. The real-time cycle of the Skylab 16K flight program.
(From IBM, Skylab Operation Assessment, ATMDC, 1974)](images/p75.jpg)

\[**76**\] ....called in the other ways**^[44](Source3.html)^**. The
...
\[**77**\] tests of the computer system and an error detection program
...
\[**78**\] The Skylab software development was done in a programming
...
\[**79**\] The verification process was scheduled for the final 10 weeks
