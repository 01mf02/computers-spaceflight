...
\[**258**\] Mission control of unmanned spacecraft is significantly
...
period, it did satellite work. JPL developed the \[**260**\] guidance
...
\[**261**\] Planning for the first Mariner missions revealed that more
...
\[**262**\] Even though expected to handle all deep space missions, some
...
\[**263**\] As in the manned programs, during critical mission phases
...
\[**264**\] In October of 1969, JPL installed its first System 360/75, a
...
landers**^[102](Source8.html)^**. At peak, 700 controllers \[**265**\]
...
![\[**266**\] Figure 8-4. A schematic of the components of the Space Flight
Operations Facility. (JPL 333-660)](images/p266.jpg)

\[**267**\] By the early 1980s, the Deep Space Network was heavily into
...
![\[**268**\] Figure 8-5. The 64-meter antenna of the Deep Space Network at
