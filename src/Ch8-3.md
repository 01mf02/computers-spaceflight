...
Although two of the 7090s and later \newpageon{259} other computers
...
period, it did satellite work. JPL developed the \newpageon{260} guidance
...
\newpageon{261} Planning for the first Mariner missions revealed that more
...
\newpageon{262} Even though expected to handle all deep space missions, some
...
\newpageon{263} As in the manned programs, during critical mission phases
...
landers**^[102](Source8.html)^**. At peak, 700 controllers \newpageon{265}
...
\newpageon{267} By the early 1980s, the Deep Space Network was heavily into
