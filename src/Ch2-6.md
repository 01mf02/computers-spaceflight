...
\[**40**\] Development of the on-board software for the Apollo program
...
those systems, the Apollo software effort helped \[**41**\] provide
...
solution are among the goals of software engineering. In \[**42**\] the
...
\[**43**\] specification. In most cases, a team from the software
...
listing**^[83](Source2.html)^**. The tape \[**44**\] containing the
...
\[**45**\] One can program a computer on several levels. Machine code,
...
\[**46**\] computer systems and real-time systems is the fact that in
...
descent**^[106](Source2.html)^**. The restarts \[**47**\] caused a
...
\[**48**\] release of the program for rope manufacture was dependent on
...
By early 1966, program requirements even exceeded the Block H computer's
...
\[**49**\] additional problems. Thus, NASA's contract managers had to
...
orbit \[**50**\] rendezvous but actually minimal enough to be
...
\[**51**\] computer calculated the time for the de-orbit burn that
...
\[**52**\] Even while the Task Force was investigating, Mueller took
...
\[**53**\] executed, and (e) more programmers do not mean faster
...
[^n1]: Members of the Task Force included Richard H. Battin,
MIT; Leon R. Bush, Aerospace Corp.; Donald R.Hagner, Bellcomm; Dick
Hanrahan; IBM; James S. Martin, NASA-Langley; John P. Mayer, NASA-MSC;
Clarence Pitman; TRW; and Ludie G.Richard; NASA-Marshall. Mueller was
the chairman.
