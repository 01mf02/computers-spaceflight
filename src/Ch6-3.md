...
leaving Galileo without a ride to Jupiter. \newpageon{188} By early 1987,
...
\newpageon{189} Finally, computer system complexity is further increased by
...
\newpageon{190} JPL considered software crucial to the success of the
...
but \newpageon{192} only one bus was needed to support all processors
...
\newpageon{198} Design of the software was done in a JPL-developed Software
...
\newpageon{202} designers is the effect of highly charged particle impacts
...
chosen**^[146](Source6.html)^**. As a footnote, \newpageon{203} it is
