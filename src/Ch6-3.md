...
\[**186**\] Project Galileo began at JPL in the late 1970s with the
...
![\[**187**\] Figure 6-3. The Unified Data System: precursor to Galileo's Command
...
![\[**191**\] Figure 6-5. Galileo and its booster being deployed from an orbiting
...
![\[**193**\] Figure 6-6. Circuit boards for the Galileo Command and Data Subsystem.
(JPL Photo 360-1756)](images/p193.jpg)

<div class="box"
title="Box 6-4: Evolution of the Command and Data Subsystem">
...
\[**194**\] Development of the software for this Subsystem consumed more
...
![\[**195**\] Figure 6-7. Memory modules for the Galileo Command and Data Subsystem.
...
![\[**196**\] Figure 6-8. The software architecture of the Galileo Command and Data
...
<div class="box"
title="[&lt;b&gt;197&lt;/b&gt;] Box 6-5: Command and Data Subsystem Software Architecture">
...
![\[**199**\] Figure 6-9. The central processor and input/output circuits of the
...
![\[**200**\] Figure 6-10. Memory modules of the Galileo attitude control computers.
...
<div class="box"
title="[&lt;b&gt;201&lt;/b&gt;] Box 6-6: Configuration of the Attitude Control Electronics">
