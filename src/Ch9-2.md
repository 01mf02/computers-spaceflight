...
\[**270**\] NASA's requirements for flight simulators far exceeded the
...
\[**271**\] simulator, such as a simulator in which a spacecraft cabin
...
Pennsylvania, served as \[**272**\] a moving-base simulator. A Mercury
...
Simulator, the on-board computer was not installed, but the \[**273**\]
...
![\[**274**\] Figure 9-1A. The Apollo Command Module Mission Simulator. (NASA photo
...
\[**275**\] No less than 15 simulators trained crews during the Apollo
...
Simulators. These \[**276**\] computers simulated the on-board
...
Goeckler of the Systems Engineering Division of the program \[**277**\]
...
computers. In the end, \[**278**\] the simulation within a simulation
...
![\[**279**\] Figure 9-2. The fixed base Shuttle Simulator (upper center) with some
...
\[**280**\] UNIVAC computers, eliminating the time advantage the DDP
...
appropriate place. The teaching software is based on \[**281**\]
...
\[**282**\] While flight simulators are the glory of the simulation
...
minicomputers, the hybrids modeled booster \[**283**\] flight
...
\[**284**\] The main engine of the space Shuttle is another complicated
...
\[**285**\] Since Marshall was responsible for all the booster
...
![\[**286**\] Figure 9-5. Astronaut John O. Creighton in the cockpit of the Shuttle
...
\[**287**\] Since the Shuttle was the First manned spacecraft to fly
