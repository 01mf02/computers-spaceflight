...
\newpageon{271} simulator, such as a simulator in which a spacecraft cabin
...
Pennsylvania, served as \newpageon{272} a moving-base simulator. A Mercury
...
Simulator, the on-board computer was not installed, but the \newpageon{273}
...
Simulators. These \newpageon{276} computers simulated the on-board
...
Goeckler of the Systems Engineering Division of the program \newpageon{277}
...
computers. In the end, \newpageon{278} the simulation within a simulation
...
\newpageon{280} UNIVAC computers, eliminating the time advantage the DDP
...
appropriate place. The teaching software is based on \newpageon{281}
...
\newpageon{282} While flight simulators are the glory of the simulation
...
minicomputers, the hybrids modeled booster \newpageon{283} flight
...
\newpageon{285} Since Marshall was responsible for all the booster
...
\newpageon{287} Since the Shuttle was the First manned spacecraft to fly
