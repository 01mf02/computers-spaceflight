...
\[**108**\] During 1973 and 1974 the first requirements began to be
...
As time went on, Rockwell's responsibilities as \[**109**\] prime
...
\[**110**\] Although the decision to program in a high-level language
...
was retained as a consultant by NASA and contributed two \[**111**\] key
...
Rockwell and IBM fell victim to the "not invented here" \[**112**\]
...
convinced it would never work**^[l03](Source4.html)^**.
...
<div class="inbox">\[**113**\] Box 4-3: Structure of PASS Applications Software
...
![\[**114**\] Figure 4-6. A block diagram of the Shuttle flight computer software
...
method of implementing these statements is controlled \[**115**\] by a
...
Table: \[**116**\] Table 4-1: Sizes of Software Loads in PASS.
...
modules developed for \[**117**\] the Shuttle, such as the general
...
360s filled up, so NASA considered the Shuttle Mission \[**118**\]
...
\[**119**\] less than half the members of the development group and uses
...
<div class="inbox">\[**120**\] Box 4-4: How IBM Verifies the Shuttle Flight Software
...
\[**121**\] The software is usually installed in the SAIL for prelaunch,
...
<div class="inbox">\[**122**\] Box 4-5: The Nature of the Backup Flight System
