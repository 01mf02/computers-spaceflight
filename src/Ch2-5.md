...
\[**34**\] The Apollo Guidance Computer was fairly compact for a
...
\[**35**\] adjacent words yielded "double precision" and three adjacent,
...
\[**36**\] addressing of the erasable memory to its "upper" region, and
...
Apollo's computer used erasable merry cells to store intermediate
...
\[**37**\] development problems, despite the increase of fixed memory 18
...
<div class="inbox">\[**38**\] Box 2-1: Core Rope: A Unique Data Storage Device
...
![\[**39**\] Figure 2-1. This diagram shows the principle behind core rope. Suppose
...
the wire attached to the core will indicate a ](images/p39.jpg)
...
largely because of its Polaris experience, but it had \[**40**\] never
