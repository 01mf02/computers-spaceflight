...
\newpageon{35} adjacent words yielded "double precision" and three adjacent,
...
\newpageon{36} addressing of the erasable memory to its "upper" region, and
...
\newpageon{37} development problems, despite the increase of fixed memory 18
...
largely because of its Polaris experience, but it had \newpageon{40} never
