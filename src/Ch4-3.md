...
\newpageon{96} Due to packaging considerations, the core memory is located
...
full power for 20 microseconds. \newpageon{97} If no further accesses are
...
\newpageon{98} with the central processor and may have the effect of
...
larger on the Shuttle's screens, necessary because although \newpageon{99}
