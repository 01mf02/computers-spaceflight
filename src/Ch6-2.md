...
\newpageon{174} Voyager in the mid-1970s. Although TOPS' original mission
...
work to be \newpageon{175} done informally, easing communication. To provide
...
30 times per minute, caused concern \newpageon{176} that the CCS would be
...
\newpageon{177} spacecraft configurations. NASA's Office of Aeronautics and
...
were the key personnel \newpageon{178} involved in making the final
...
\newpageon{180} Since this was one of the mission-critical times that the
...
includes what appears to be the flight version of the \newpageon{181}
...
\newpageon{182} software. With those decisions made, a preliminary
...
\newpageon{183} James T. Kinsey, a JPL manager, was instrumental in getting
...
machine \newpageon{185} was chosen. For example, at one point Rice and
...
attitude control computer were still programming, \newpageon{186} preparing
